...
Date: 05/02/2020
Application: Black Jack Game
 */
package skelton_blackjack;

import skelton_blackjack.Card;
...
public class Skelton_BlackJack extends Application {
        ...
        standbtn.setOnAction((e) -> {
            if(playerTurn == true && busted != true){
                ...
                if(dealerTotal <= 21 && playerTotal == dealerTotal){
                    ...
                    // you lost 
                    System.out.println(" MAYBE NEXT HAND! ");  
                    status.setText(" MAYBE NEXT HAND! "); 
                } else {
                    // you won 
